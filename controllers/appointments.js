...
exports.getAppointments = async (req, res, next) => {
    ...
    try{
        ...
        console.log(err);
        return res.status(500).json({ success: false, error: 'Cannot find Appointment' });
    }
};
...
exports.addAppointment = async (req, res, next) => {
    try{
        ...
        console.log(err);
        return res.status(500).json({ success: false, error: 'Cannot create Appointment' });
    }
};
...
exports.updateAppointment = async (req, res, next) => {
    try{
        ...
        console.log(err);
        return res.status(500).json({ success: false, error: 'Cannot update Appointment' });
    }
};
...
exports.deleteAppointment = async (req, res, next) => {
    try{
        ...
        console.log(err);
        return res.status(500).json({ success: false, error: 'Cannot delete Appointment' });
    }
}